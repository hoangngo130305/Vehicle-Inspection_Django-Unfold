...
export default function AuthScreen({ onLoginSuccess }: AuthScreenProps) {
  ...
  const [forgotStep, setForgotStep] = useState<"phone" | "otp" | "password">(
    "phone",
  );
    ...
    try {
      ...
      if (errorMessage.includes("chưa được đăng ký")) {
        toast.error(errorMessage, {
          duration: 4000,
          description:
            'Vui lòng chuyển sang tab "Đăng ký" để tạo tài khoản mới.',
        });
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-5 space-y-4 backdrop-blur-xl">
          {authMode === "login" && (
            <>
              ...
              {/* CUSTOMER LOGIN */}
              {userType === "customer" && !forgotPasswordMode && (
                <>
              ...
              {/* STAFF LOGIN */}
              {userType === "staff" && !forgotPasswordMode && (
                <>
                  <div className="space-y-3">
                    <div>
                      <label className="block text-xs font-semibold text-gray-700 mb-1.5">
              ...
              {/* ADMIN LOGIN */}
              {userType === "admin" && !forgotPasswordMode && (
                <>
                  <div className="space-y-3">
                    <div>
                      <label className="block text-xs font-semibold text-gray-700 mb-1.5">
